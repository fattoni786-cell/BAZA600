...
def movie_personal_prompt_keyboard() -> None:
    return None


def movie_personal_question_keyboard(
    answers: list[str],
    current_index: int,
    total: int,
    ...
    keyboard = [
        [
            InlineKeyboardButton(
                text=answer_text,
                callback_data=f"movie_personal_answer:{idx}",
            )
        ]
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                ...
                callback_data="movie_personal_progress",
            )
        ]
    )
...
def personal_movie_keyboard(
        ...
        keyboard.append(
            [
                InlineKeyboardButton(
                    ...
                    callback_data="movie_personal_backup",
                )
            ]
        )
    ...
    keyboard.append(
        [InlineKeyboardButton(text="🧠 Новый персональный подбор", callback_data="movies_personal")]
    )

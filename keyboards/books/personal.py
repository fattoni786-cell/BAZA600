...
def book_personal_prompt_keyboard() -> None:
    return None


def book_personal_question_keyboard(
    answers: list[str],
    current_index: int,
    total: int,
    ...
    keyboard = [
        [
            InlineKeyboardButton(
                text=answer_text,
                callback_data=f"book_personal_answer:{idx}",
            )
        ]
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                ...
                callback_data="book_personal_progress",
            )
        ]
    )
...
def personal_book_keyboard(
    ...
    if has_backup:
        keyboard.append(
            [InlineKeyboardButton(text="🎲 Запасной вариант", callback_data="book_personal_backup")]
        )
    ...
    keyboard.append(
        [InlineKeyboardButton(text="🧠 Новый персональный подбор", callback_data="books_personal")]
    )

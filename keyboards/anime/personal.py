...
def anime_personal_prompt_keyboard() -> None:
    return None


def anime_personal_question_keyboard(
    answers: list[str],
    current_index: int,
    total: int,
    ...
    keyboard = [
        [
            InlineKeyboardButton(
                text=answer_text,
                callback_data=f"anime_personal_answer:{idx}",
            )
        ]
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                ...
                callback_data="anime_personal_progress",
            )
        ]
    )
...
def personal_anime_keyboard(
        ...
        keyboard.append(
            [
                InlineKeyboardButton(
                    ...
                    callback_data="anime_personal_backup",
                )
            ]
        )
    ...
    keyboard.append(
        [InlineKeyboardButton(text="🧠 Новый персональный подбор", callback_data="anime_personal")]
    )
